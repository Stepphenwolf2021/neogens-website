...
ROWS = [
    ...
    ("Ethiopia",           38.7,   7.7, "origin", 420,   9, 18, 11,  7, 3, 3, 1, 86.4, "1,700–2,200 m","jasmine · bergamot · peach","natural"),
    ...
    ("Yemen",              44.2,  15.0, "origin",  35,   1,  2,  2,  1, 0, 1, 0, 85.8, "1,500–2,200 m","dried fig · incense",       "natural"),
    ("Panama",            -82.4,   8.8, "origin",  30,   3,  2,  2,  1, 1, 1, 1, 88.2, "1,400–1,900 m","jasmine · bergamot",        "washed"),
