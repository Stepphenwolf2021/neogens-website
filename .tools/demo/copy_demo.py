...
TH = {
    ...
    "desc": "แดชบอร์ดจำลองของคลังความรู้กาแฟ ผู้ร่วมสร้างคลังห้าพันรายตลอดห่วงโซ่ "
            "กราฟความรู้วางซ้อนบนแผนที่โลก และคำถามที่เกษตรกรกับโรงคั่วจะถามมันจริง ๆ",
    "kicker": "MKM สำหรับกาแฟ · เดโม",
    "h1": "คลังความรู้กาแฟ เมื่อมีคนอยู่ในนั้นห้าพันคน",
    "stand": "ภาพจำลองของคลังความรู้กาแฟ ทุกต้นทาง ทุกตลาด และเส้นทางที่มีล็อตผ่านการยืนยัน "
    ...
    "stats": ["ผู้ร่วมสร้างคลัง", "เกษตรกร", "โรงคั่ว", "สหกรณ์และโรงสี",
              "ผู้ส่งออกและผู้นำเข้า", "ร้านกาแฟ", "นักวิจัย", "ผู้ตรวจรับรอง"],
    "stats_sub": ["43 ต้นทางและตลาด", "80% ของทั้งคลัง", "10%",
                  "ชั้นที่รวบรวมผลผลิต", "งานเอกสารและการขนส่ง", "ปลายทางสุดท้าย",
                  "เกษตรศาสตร์และการชิม", "ตรวจสอบโดยคนนอก"],
    "legend": ["ต้นทาง · แปลง สหกรณ์ โรงสี", "ตลาด · โรงคั่ว ร้านกาแฟ ผู้นำเข้า",
    ...
    "tools": ["เส้นทางการค้าทั้งหมด", "เฉพาะแหล่งกาแฟคะแนนสูง",
              "เฉพาะที่โรงคั่ว/ผู้ซื้อที่ตรงโปรไฟล์", "เฉพาะผู้มีส่วนเกี่ยวข้อง"],
    "slider": "คะแนนคัปปิ้ง",
    "slider_any": "ทั้งหมด",
    ...
    "thead": ["ล็อต", "ต้นทาง", "วิธีแปรรูป", "คะแนน", "รสชาติ", "สาวกลับได้", "ผู้ซื้อที่ตรงกัน"],
    "hops": "ช่วง",
    ...
    "labels": {
        "participants": "ราย",
        "today": "คลังในวันนี้",
        "contributors5k": "ผู้ร่วมสร้างคลัง 5,000 ราย",
        "originsMarkets": "43 ต้นทางและตลาด · ข้อมูลจำลอง",
        "farmers": "เกษตรกร",
        "roasters": "โรงคั่ว",
        "coops": "สหกรณ์",
        ...
        "hint": "คลิกจุดไหนบนแผนที่ก็ได้ เพื่อดูว่าต้นทางนั้นลงอะไรไว้ในคลังบ้าง "
                "และโปรไฟล์ของมันตรงกับโรงคั่วรายไหน",
        "origin": "ต้นทาง",
        "market": "ตลาด",
        "marketSub": "โรงคั่ว ร้านกาแฟ และผู้นำเข้า",
        "contributors": "ผู้ร่วมสร้างคลัง",
        ...
        "place": {
            ...
            "DR Congo": "คองโก", "Rest of origins": "ต้นทางอื่น ๆ",
