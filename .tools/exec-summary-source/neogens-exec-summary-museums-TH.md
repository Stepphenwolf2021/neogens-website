...
มีงานสำรวจที่พอจะบอกได้ว่ารายงานฉบับนั้นจะเจออะไร Museums & AI Survey ของ MuseumWeek กับ Culture For Causes Network เก็บข้อมูลจาก 180 หน่วยงานใน 35 ประเทศ ระหว่าง 17 กันยายน ถึง 14 พฤศจิกายน 2025 พบว่า 52% รับ AI เข้ามาใช้ในงานแล้ว อีก 11% ไม่รู้ว่าคนในองค์กรของตัวเองใช้อยู่หรือเปล่า มี 9% ที่มีธรรมนูญหรือนโยบายเรื่อง AI เป็นลายลักษณ์อักษร และ 26% ที่เคยผ่านการอบรมเรื่อง AI มาบ้าง

การใช้งานวิ่งนำกติกาไปแล้ว ส่วนการอบรมวิ่งตามหลังทั้งสองอย่าง

[[FIGURE:survey]]

ขอตั้งข้อสังเกตเรื่องตัวเลขชุดนี้ไว้ตรงนี้ เพราะทั้งเอกสารฉบับนี้พูดเรื่องตัวเลขที่ตรวจย้อนกลับได้ บทความสรุปผลของผู้จัดทำเองเขียนไว้ว่า 46% กับ 8% ขณะที่การ์ดรายงานของเขาเขียนว่า 52% กับ 9% เราเลือกใช้ตัวเลขจากการ์ด เพราะการ์ดกำกับฐานและสัดส่วนคนที่ตอบว่าไม่รู้ ไว้ทุกตัว และผู้ตอบเป็นกลุ่มที่สมัครใจตอบ จำนวนไม่มาก ทิศทางไม่ต้องสงสัย ตัวเลขหลังจุดต่างหากที่ต้องระวัง

ฝั่งผู้เข้าชมก็มีคำตอบของตัวเอง มกราคม 2026 American Alliance of Museums ถามคำถามเรื่อง AI ในพิพิธภัณฑ์กับกลุ่มตัวอย่างผู้ใหญ่ในสหรัฐกว่า 2,000 คน ที่คุมสัดส่วนตามโครงสร้างประชากร แล้วเผยแพร่ผลในเดือนมีนาคมปีเดียวกัน มากกว่า 70% ไม่อยากให้พิพิธภัณฑ์ใช้ AI ในการพัฒนานิทรรศการเลย 43% อยากให้คนเป็นผู้เขียนเนื้อหาทุกชิ้นของพิพิธภัณฑ์ ลงไปถึงอีเมลและข้อความบนเว็บ และ 45% อยากรู้ทุกครั้งที่มีการใช้ AI
